...
#define CPU_RAM_MIRRORED_SIZE (CPU_GENUINE_RAM_LAST_ADDRESS -CPU_GENUINE_RAM_FIRST_ADDRESS + 1)
#define CPU_RAM_MIRROR_FIRST_ADDRESS (CPU_GENUINE_RAM_LAST_ADDRESS + 1)
#define CPU_RAM_MIRROR_LAST_ADDRESS 0x1FFF
#define CPU_RAM_MIRROR_SIZE (CPU_RAM_MIRROR_LAST_ADDRESS - CPU_RAM_MIRROR_FIRST_ADDRESS+ 1)
...
#define CPU_PPU_MIRRORED_SIZE (CPU_GENUINE_PPU_LAST_ADDRESS -CPU_GENUINE_PPU_FIRST_ADDRESS +1)
#define CPU_PPU_MIRROR_FIRST_ADDRESS (CPU_GENUINE_PPU_LAST_ADDRESS + 1)
#define CPU_PPU_MIRROR_LAST_ADDRESS 0x3FFF
#define CPU_PPU_MIRROR_SIZE (CPU_PPU_MIRROR_LAST_ADDRESS - CPU_PPU_MIRROR_FIRST_ADDRESS+ 1)
